...
export INIT='{"admin":"","rake_basis_points":150}'
...
#Execute a Bet operation to fund the bank
...
#Execute a Bet operation to test
zenrockd tx wasm execute zen14hj2tavq8fpesdwxxcu44rty3hh90vhujrvcmstl4zr3txmfvw9s38wvxu '{"bet":{"guess":1,"to":"zen13y3tm68gmu9kntcxwvmue82p6akacnpt2v7nty","odds":1}}' --from alice --amount=100urock  $TXFLAG -y
